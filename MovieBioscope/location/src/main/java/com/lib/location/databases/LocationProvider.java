...
public class LocationProvider extends ContentProvider {
    ...
    private static final String CREATE_LOCATION_TABLE = "CREATE TABLE IF NOT EXISTS "
            ...
            + LOCATION_COLUMNS.SOURCE + " TEXT," + LOCATION_COLUMNS.DESTINATION + " TEXT," + LOCATION_COLUMNS.CURRENT_LOCATION + " TEXT,"+ LOCATION_COLUMNS.CITY + " TEXT," + LOCATION_COLUMNS.TOTAL_DISTANCE + " TEXT," + LOCATION_COLUMNS.TOTAL_TIME + " TEXT," + LOCATION_COLUMNS.DISTANCE_TO_SOURCE + " TEXT," + LOCATION_COLUMNS.DISTANCE_TO_DESTINATION + " TEXT," + LOCATION_COLUMNS.TIME_TO_DESTINATION + " TEXT," + LOCATION_COLUMNS.LAST_SYNC_TIME + " TEXT" + ")";
