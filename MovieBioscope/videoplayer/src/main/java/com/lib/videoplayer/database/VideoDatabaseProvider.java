...
public class VideoDatabaseProvider extends ContentProvider {
    ...
    private static final String TAG = VideoDatabaseProvider.class.getSimpleName();
    ...
    public static final String AUTHORITY = "com.lib.videoplayer.contentprovider.database.VideoDatabaseProvider";
